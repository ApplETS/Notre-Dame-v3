...
@class ETSKDashboardCardRepository, ETSKDashboardCardQueries, ETSKDashboardCard, ETSKDashboardViewModel, ETSKViewModel, ETSKFetchDashboardCardsUseCase, ETSKRestoreDashboardCardsUseCase, ETSKSaveDashboardCardsUseCase, ETSKEtsMobileDispatchers, ETSKKotlinx_coroutines_core_nativeCoroutineDispatcher, ETSKActivite, ETSKCours, ETSKDashboardCardType, ETSKKotlinEnum, ETSKEnseignant, ETSKEtudiant, ETSKEvaluation, ETSKEvaluationCours, ETSKHoraireExamenFinal, ETSKJourRemplace, ETSKProgramme, ETSKSeance, ETSKSession, ETSKSignetsUserCredentials, ETSKUniversalCode, ETSKSignetsUserCredentialsCompanion, ETSKSommaireElementsEvaluation, ETSKSommaireEtEvaluations, ETSKUniversalCodeError, ETSKDashboardCardEntityAdapter, ETSKDashboardCardEntityImpl, ETSKSqldelight_runtimeTransacter, ETSKSqldelight_runtimeQuery, ETSKKotlinUnit, ETSKSqldelight_runtimeTransacterTransaction, ETSKEtsMobileDb, ETSKEtsMobileDbSchema, ETSKKotlinNumber, ETSKKotlinThrowable, ETSKKotlinx_coroutines_core_nativeCancellationException, ETSKKotlinAbstractCoroutineContextElement, ETSKKotlinByteArray, ETSKKotlinArray, ETSKKotlinIllegalStateException, ETSKKotlinRuntimeException, ETSKKotlinException, ETSKKotlinByteIterator, ETSKKotlinx_coroutines_core_nativeAtomicDesc, ETSKKotlinx_coroutines_core_nativeAtomicOp, ETSKKotlinx_coroutines_core_nativeOpDescriptor;

@protocol ETSKKotlinx_coroutines_core_nativeReceiveChannel, ETSKKotlinx_coroutines_core_nativeJob, ETSKKotlinx_coroutines_core_nativeCoroutineScope, ETSKAndroidParcel, ETSKKotlinComparable, ETSKDashboardCardEntity, ETSKSqldelight_runtimeColumnAdapter, ETSKSqldelight_runtimeSqlDriver, ETSKSqldelight_runtimeSqlDriverSchema, ETSKSqldelight_runtimeSqlCursor, ETSKSqldelight_runtimeQueryListener, ETSKKotlinx_coroutines_core_nativeChannelIterator, ETSKKotlinx_coroutines_core_nativeSelectClause1, ETSKKotlinx_coroutines_core_nativeChildHandle, ETSKKotlinx_coroutines_core_nativeChildJob, ETSKKotlinx_coroutines_core_nativeDisposableHandle, ETSKKotlinSequence, ETSKKotlinx_coroutines_core_nativeSelectClause0, ETSKKotlinCoroutineContextElement, ETSKKotlinCoroutineContextKey, ETSKKotlinCoroutineContext, ETSKKotlinContinuationInterceptor, ETSKKotlinContinuation, ETSKKotlinx_coroutines_core_nativeRunnable, ETSKSqldelight_runtimeSqlPreparedStatement, ETSKSqldelight_runtimeCloseable, ETSKKotlinx_coroutines_core_nativeSelectInstance, ETSKKotlinSuspendFunction1, ETSKKotlinx_coroutines_core_nativeParentJob, ETSKKotlinIterator, ETSKKotlinSuspendFunction0, ETSKKotlinSuspendFunction;
...
- (instancetype)initWithFetchDashboardCardsUseCase:(ETSKFetchDashboardCardsUseCase *)fetchDashboardCardsUseCase restoreDashboardCardsUseCase:(ETSKRestoreDashboardCardsUseCase *)restoreDashboardCardsUseCase saveDashboardCardsUseCase:(ETSKSaveDashboardCardsUseCase *)saveDashboardCardsUseCase __attribute__((swift_name("init(fetchDashboardCardsUseCase:restoreDashboardCardsUseCase:saveDashboardCardsUseCase:)"))) __attribute__((objc_designated_initializer));
...
- (void)restore __attribute__((swift_name("restore()")));
@property (readonly) id<ETSKKotlinx_coroutines_core_nativeReceiveChannel> cardsChannel;
@property (readonly) id<ETSKKotlinx_coroutines_core_nativeReceiveChannel> showUndoRemoveChannel;
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FetchDashboardCardsUseCase")))
@interface ETSKFetchDashboardCardsUseCase : KotlinBase
...
- (id<ETSKKotlinx_coroutines_core_nativeReceiveChannel>)invoke __attribute__((swift_name("invoke()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RestoreDashboardCardsUseCase")))
@interface ETSKRestoreDashboardCardsUseCase : KotlinBase
- (instancetype)initWithRepository:(ETSKDashboardCardRepository *)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));
- (void)invoke __attribute__((swift_name("invoke()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SaveDashboardCardsUseCase")))
@interface ETSKSaveDashboardCardsUseCase : KotlinBase
- (instancetype)initWithRepository:(ETSKDashboardCardRepository *)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));
- (void)invokeVisibleCards:(NSArray<ETSKDashboardCard *> *)visibleCards hiddenCards:(NSArray<ETSKDashboardCard *> *)hiddenCards __attribute__((swift_name("invoke(visibleCards:hiddenCards:)")));
@end;
...
- (instancetype)initWithCours:(NSString *)cours groupe:(NSString *)groupe session:(NSString *)session nom:(NSString *)nom equipe:(NSString *)equipe dateCible:(id _Nullable)dateCible note:(NSString * _Nullable)note corrigeSur:(NSString * _Nullable)corrigeSur notePourcentage:(NSString * _Nullable)notePourcentage ponderation:(NSString *)ponderation moyenne:(NSString * _Nullable)moyenne moyennePourcentage:(NSString * _Nullable)moyennePourcentage ecartType:(NSString * _Nullable)ecartType mediane:(NSString * _Nullable)mediane rangCentile:(NSString * _Nullable)rangCentile publie:(BOOL)publie messageDuProf:(NSString *)messageDuProf ignoreDuCalcul:(BOOL)ignoreDuCalcul __attribute__((swift_name("init(cours:groupe:session:nom:equipe:dateCible:note:corrigeSur:notePourcentage:ponderation:moyenne:moyennePourcentage:ecartType:mediane:rangCentile:publie:messageDuProf:ignoreDuCalcul:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (NSString *)component4 __attribute__((swift_name("component4()")));
...
@property NSString * _Nullable note;
@property NSString * _Nullable corrigeSur;
@property NSString * _Nullable notePourcentage;
@property NSString *ponderation;
@property NSString * _Nullable moyenne;
@property NSString * _Nullable moyennePourcentage;
@property NSString * _Nullable ecartType;
@property NSString * _Nullable mediane;
@property NSString * _Nullable rangCentile;
...
- (instancetype)initWithSigleCours:(NSString *)sigleCours session:(NSString *)session note:(NSString * _Nullable)note noteSur:(NSString * _Nullable)noteSur noteSur100:(NSString * _Nullable)noteSur100 moyenneClasse:(NSString * _Nullable)moyenneClasse moyenneClassePourcentage:(NSString * _Nullable)moyenneClassePourcentage ecartTypeClasse:(NSString * _Nullable)ecartTypeClasse medianeClasse:(NSString * _Nullable)medianeClasse rangCentileClasse:(NSString * _Nullable)rangCentileClasse noteACeJourElementsIndividuels:(NSString * _Nullable)noteACeJourElementsIndividuels noteSur100PourElementsIndividuels:(NSString * _Nullable)noteSur100PourElementsIndividuels __attribute__((swift_name("init(sigleCours:session:note:noteSur:noteSur100:moyenneClasse:moyenneClassePourcentage:ecartTypeClasse:medianeClasse:rangCentileClasse:noteACeJourElementsIndividuels:noteSur100PourElementsIndividuels:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
...
@property NSString *session;
@property NSString * _Nullable note;
@property NSString * _Nullable noteSur;
@property NSString * _Nullable noteSur100;
@property NSString * _Nullable moyenneClasse;
@property NSString * _Nullable moyenneClassePourcentage;
@property NSString * _Nullable ecartTypeClasse;
@property NSString * _Nullable medianeClasse;
@property NSString * _Nullable rangCentileClasse;
@property NSString * _Nullable noteACeJourElementsIndividuels;
@property NSString * _Nullable noteSur100PourElementsIndividuels;
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SqlDriverExtKt")))
@interface ETSKSqlDriverExtKt : KotlinBase
+ (ETSKEtsMobileDb *)createDb:(id<ETSKSqldelight_runtimeSqlDriver>)receiver __attribute__((swift_name("createDb(_:)")));
@end;
