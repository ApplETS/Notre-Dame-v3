...
class SecurityAdapter(private val securityList: List<String>, val findNavController: NavController) : RecyclerView.Adapter<SecurityAdapter.SecurityViewHolder>() {
...
//            findNavController.navigate(R.id.securityDetailFragment, securityList[position])
        }
